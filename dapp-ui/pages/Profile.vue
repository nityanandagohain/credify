        ...
        <div class>
          <div class="columns">
            <div class="column">
              ...
              />
              <span class="loan-demand">Amount Received: {{i.amount_recieved}}</span>

              <!-- <div class="superb">
                <span>Amount Received</span>
                <span style="margin-left:10px; color: darkgrey;">{{i.amount_recieved}}</span>
              </div>-->
              <div class="superb">
                <span>Amount Requested</span>
                <span style="margin-left:10px; color: darkgrey;">{{i.requested_amount}}</span>
              </div>
              <div class="superb">
...
export default {
  ...
  async mounted() { 
    ...
    this.myLoans = properties.myLoans;
